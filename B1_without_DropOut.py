...
if (__name__ == '__main__'):
    ...
    class MBConv(nn.Module):
        def __init__(self, inputCh, outputCh, filterSize, stride, expandRatio, SERatio):
    ...
    class ConvNet(nn.Module):
      def __init__(self, num_classes=10):
          ...
          #stride=2, repeat stride = 1
          self.mbconv3= MBConv(24,  40, 5, 2, 6, 0.25)
          self.mbconv3repeat= MBConv(40, 40,  5, 1, 6, 0.25)
          #stride=2, repeat stride = 1
          self.mbconv4= MBConv(40,  80, 3, 2, 6, 0.25)
          self.mbconv4repeat= MBConv(80, 80,  3, 1, 6, 0.25)
          #stride=1, repeat stride = 1
          self.mbconv5= MBConv(80,  112, 5, 1, 6, 0.25)
          self.mbconv5repeat= MBConv(112,  112, 5, 1, 6, 0.25)
          #stride=2, repeat stride = 1
          self.mbconv6= MBConv(112, 192, 5, 2, 6, 0.25)
    ...
    restart=0
    if(restart):
          checkpoint = torch.load('b1_nodrop.pt')
    ...
    torch.save(model, 'model_B1NoDrop.pt')
