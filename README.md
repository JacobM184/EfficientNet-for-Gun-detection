...
1. Download project file(s)
    ...
    * B0_global.pt
2. Download dataset
    * our dataset can be downloaded from the following link: [https://drive.google.com/open?id=1GlK7o_nciEY4J3VlHqWvAdK28HBHrDdN]()
...
Models                                 | Dataset
---------------------------------------|------------------------
B0 with Global Pooling                 | synthetic + real images
